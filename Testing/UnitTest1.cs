...
namespace Testing
{
    ...
    public class UnitTest1
    {
        ...
        public void Setup()
        {
            ...
            Potrebitel user = new Potrebitel(0, "Pesho", "Atanasov", 52, "underfat", "235689", "idkman_01@gmail.com", 0);
            ElUsero = user;
        }
        [TestCleanup]
        public void CleanUp()
        ...
        {
            var newuser = new Potrebitel(0, "Mesho", "Atanasov", 52, "underfat", "235689", "idkman_01@gmail.com", 0);
            context.Update(newuser);

            Assert.AreEqual("Mesho", context.Read(0).Name);
        }
        [TestMethod]
